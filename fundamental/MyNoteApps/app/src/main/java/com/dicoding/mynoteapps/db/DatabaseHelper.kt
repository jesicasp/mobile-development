...
/**
 * Tanggung jawab utama dari kelas ini adalah menciptakan database dengan tabel yang dibutuhkan
 * dan handle ketika terjadi perubahan skema pada tabel (terjadi pada metode onUpgrade()).
 * Nah, di kelas ini kita menggunakan variabel yang ada pada DatabaseContract untuk
 * mengisi kolom nama tabel. Begitu juga dengan kelas-kelas lainnya nanti.
